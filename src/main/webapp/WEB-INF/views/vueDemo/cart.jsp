...
<title>主页</title>
<link href="${staticPath }/static/css/base.css" rel="stylesheet">
<link href="${staticPath }/static/css/checkout.css" rel="stylesheet">
<link href="${staticPath }/static/css/modal.css" rel="stylesheet">
<script type="text/javascript" src="${staticPath }/static/test/test.js"></script>
<style type="text/css">
.quentity input {
	width: 40px;
	padding: 5px 10px;
...
<c:set var="jump" value="jump"></c:set>
<script type="text/javascript">
</script>
</head>
<body>
    <div class="checkout" id="ddd">
      <div id="app">
                  ...
                  <li v-for="product in products">
                    <div class="cart-tab-1">
                      <div class="cart-item-check">
                        <a href="javascript:void 0" class="item-check-btn" :class="{check:product.check}" @click="selectProduct(product)">
...
<!--                         <img src="img/goods-1.jpg" alt="烟"> -->
                    ...
                    <div class="cart-tab-2">
                      <div class="item-price">{{product.price | formatMoney}}</div>
                    </div>
                    <div class="cart-tab-3">
                      <div class="item-quantity">
                        <div class="select-self select-self-open">
                          <div class="quantity">
                            <a  @click="changeNum(product,1)">+</a>
                            <input type="text" value="" v-model="product.num" disabled>
                            <a  @click="changeNum(product,2)">-</a> 
                          </div>
                        </div>
                    ...
                    <div class="cart-tab-4">
                      <div class="item-price-total">{{product.num*product.price | formatMoney}}</div>
                    </div>
            ...
            <div class="cart-foot-wrap">
              <div class="cart-foot-l">
                ...
                <div class="item-all-del">
                  <a href="javascript:void 0" class="item-del-btn" @click="selectAll(2)">
                    <span>取消全选</span>
                  </a>
                </div>
              </div>
              <div class="cart-foot-r">
                <div class="item-total">
                  Item total:{{totalMoney | formatMoney}} <span class="total-price"></span>
                </div>
